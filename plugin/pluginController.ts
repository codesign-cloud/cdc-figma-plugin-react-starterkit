figma.showUI(__html__, { width: 400, height: 320 }); // todo: Move to a config file

figma.ui.onmessage = (msg) => {
  if (msg.type === 'create-spiral') {
...
function createColorfulSpiral(count: number, shape: 'circle' | 'rectangle' | 'polygon') {
  const nodes = [];
